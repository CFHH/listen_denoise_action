...
def process_motion():
    ...
    dotest = False
    if dotest:
        inverse_bvh_datas = parameterizer.inverse_transform(expmap_datas)
        bvh_diff = inverse_bvh_datas[0].values - bvh_data.values
    ...
    diff = test_bvh_datas[0].values - bvh_datas[0].values
